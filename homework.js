...
// let toCelsius2 = num => ((num - 32)*(5/9))
// console.log(toCelsius2(212))
...
// still going over lecture notes on this =(
...
//     }
//     changepass(){
//         console.log(this.password, this.newpass)
//     }
// }
// var userOne = new User('emk', '123')
...
// let squareNegatives = arr => arr.filter(num => num < 0)

function squareNegatives(arr) {
    newArr = [];
    for (let x = 0; x < arr.length; x++) {
        if (arr[x] < 0) newArr.push(arr[x] * arr[x]);
    };
    return newArr
};
